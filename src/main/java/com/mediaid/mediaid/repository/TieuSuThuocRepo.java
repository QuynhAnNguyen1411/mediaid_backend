...
public interface TieuSuThuocRepo extends JpaRepository<TieuSuThuoc, String> {
    ...
    @Query("SELECT new com.mediaid.mediaid.DTO.form.formTieuSuYTe.TieuSuThuocDTO(" +
            "a.tieuSuThuocID, c.accountID, b.soKhamID, d.tinhTrangSuDungID, a.tenThuoc, a.batDau, a.ketThuc, a.ghiChu) " +
            "FROM TieuSuThuoc a inner join a.soKham b inner join b.taiKhoan c inner join a.tinhTrangSuDung d " +
            "where c.accountID = ?1")
