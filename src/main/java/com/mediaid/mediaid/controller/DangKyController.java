...
public class DangKyController {
    ...
    @PostMapping("/login")
    public ResponseEntity<?> login(@RequestBody @Valid DangNhapDTO dangNhapDTO, BindingResult bindingResult) {
        return authenticationService.login(dangNhapDTO, bindingResult);
    }
}
